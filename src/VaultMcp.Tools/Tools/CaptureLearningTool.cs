...
public sealed class CaptureLearningTool
{
    ...
    [Description("Persist durable domain knowledge learned during work into a controlled markdown note. Use for terms, workflows, data flows, invariants, pitfalls, and decisions — not for raw chat transcript fragments.")]
